...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/teacher/reading', name: 'TeacherReading', component: () => import('@/views/teacher/TeacherReadingView.vue'), meta: { requiresAuth: true, requiresTeacher: true } },

    // ──── Reading（レベル別多読・spec v1.0）────
    { path: '/reading', name: 'ReadingLibrary', component: () => import('@/views/reading/ReadingLibraryView.vue'), meta: { requiresAuth: true } },
